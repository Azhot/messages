...
class DummyDataProvider {
  ...
  static final List<Message> _messages = [
    Message.now(_authors[0], "First message test."),
    Message.now(_authors[1], "Second message test."),
    Message.now(_authors[1],
    ...
    Message.now(_authors[0], "Fourth message test."),
    Message.now(_authors[1], "Fifth message test."),
    Message.now(_authors[0],
